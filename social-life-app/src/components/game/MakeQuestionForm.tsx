      ...
      <div className="flex flex-col items-center w-full">
        ...
        <div className="card w-3/4 md:w-1/3 max-w-[720px] bg-white flex flex-col items-center p-5 rounded-2xl flex-none mx-auto mt-6">
          <div className="w-full">
            <h2 className="card-title text-3xl text-gray-400 font-excali ">
              Create A Question?
            </h2>
            {/* Input Box */}
            <textarea
              ...
              className="textarea textarea-bordered font-excali w-full min-h-[120px] md:min-h-40 resize-vertical"
            />
          </div>
